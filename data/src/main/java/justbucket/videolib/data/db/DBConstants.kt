...
object DBConstants {
    ...
    const val QUERY_ALL_SOURCES = "SELECT * FROM $TABLE_SOURCE_NAME ORDER BY $COLUMN_SOURCE_TEXT COLLATE NOCASE ASC"
    ...
    //TagEntity queries
    const val QUERY_ALL_TAGS = "SELECT * FROM $TABLE_TAG_NAME ORDER BY $COLUMN_TAG_TEXT COLLATE NOCASE ASC"
    ...
    const val QUERY_ALL_VIDEOS = "SELECT * FROM $TABLE_VIDEO_NAME ORDER BY $COLUMN_VIDEO_TITLE COLLATE NOCASE ASC"
}